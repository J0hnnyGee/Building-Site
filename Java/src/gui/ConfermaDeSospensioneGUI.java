...
public class ConfermaDeSospensioneGUI extends JFrame {

	public ConfermaDeSospensioneGUI(controller.Controller controller, String id) {
			//Grandezza finestra
			setSize(660,211);
			setResizable(false);
			...
			JLabel paragrafo = new JLabel("Sei sicuro/a di voler riaprire il cantiere?");
			...
			JButton conferma_button = new JButton("Conferma");
			...
			conferma_button.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
						controller.deSospensione(id);
					}  catch (SQLException er){
						System.out.print(er.getLocalizedMessage());
					}
					controller.chiudiConfermaDeSospensioneGUI();
					
				}});
			
			JButton annulla_button = new JButton("Annulla");
			...
			annulla_button.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					controller.chiudiConfermaSospensioneGUI();
