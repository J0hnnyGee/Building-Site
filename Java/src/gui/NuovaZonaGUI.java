...
public class NuovaZonaGUI extends JFrame {
	...
	public NuovaZonaGUI(controller.Controller controller,  String id) {
		...
		JLabel heading = new JLabel("Nuova Zona");
		...
		JLabel grandezza_label = new JLabel("Grandezza:");
		...
		JLabel responsabile_label = new JLabel("Responsabile:");
	...
	//METODI
		...
		public boolean check() {
	 		if (! intero( grandezza_field, "ATTENZIONE! Inserire corretamente grandezza."))
			    return false;
	 		else return true;
		}
