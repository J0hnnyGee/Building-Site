...
public class ConfermaSospensioneGUI extends JFrame {

	public ConfermaSospensioneGUI(controller.Controller controller, String id) {
			//Grandezza finestra
			setSize(660,211);
			setResizable(false);
			...
			JLabel paragrafo = new JLabel("Sei sicuro/a di voler sospendere il cantiere?");
