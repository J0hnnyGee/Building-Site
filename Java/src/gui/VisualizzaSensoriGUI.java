...
public class VisualizzaSensoriGUI extends JFrame {
	...
	private String[] nomiColonne = {"Id", "Tipo", "Dato", "Soglia", "Zona", "Posizione", "Operatore"};
	...
	public VisualizzaSensoriGUI(controller.Controller controller, ArrayList<Sensore> listaSensori, String id_can) {
		...
		JLabel sensori_label = new JLabel("Lista Sensori");
		...
		JButton dato_button = new JButton("<html><center>Aggiungi Dato<br/>Sensore</center></html>");
		...
		JButton sogliaGas_button = new JButton("<html><center>Modifica Soglia<br/>Gas</center></html>");
		...
		JButton sogliaRumore_button = new JButton("<html><center>Modifica Soglia<br/>Rumore</center></html>");
		...
		JButton gas_button = new JButton("Filtra Gas");
		...
		JButton reset_button = new JButton("Reset/Aggiorna");
	...
	public boolean allarme(ArrayList <Sensore> sensori) {
		for(int i=0; i<sensori.size();i++) {
			if((sensori.get(i).getDato())>(sensori.get(i).getSoglia())){
				allarmeMessage("Attenzione uno o più sensori superano la soglia di allarme!");
			return false;
			}
		}
		return true;
