...
public class LoginGUI extends JFrame {
	...
	public LoginGUI(controller.Controller controller, ArrayList<Login> listaCredenziali) {
		...
		JLabel login_title = new JLabel("Welcome to WorKing");
		...
		JLabel login_subtitle = new JLabel("Because in our work we are the King");
	...
	//METODI
		...
		if(flag==1) {
			...
			JOptionPane.showMessageDialog(this, "Warning, Check Username or Password!", "", JOptionPane.INFORMATION_MESSAGE);
