...
public class AggiungiDipendenteGUI extends JFrame {
	...
	public AggiungiDipendenteGUI(controller.Controller controller,  String id) {
				...
				JLabel ruolo_label = new JLabel("Role:");
				...
				JButton aggiungi_button = new JButton("Add");
	...
	public boolean check() {
		 		if (! vuoto( nome_field, "WARNING! Insert Name."))
				    return false;
				  else
				  if (! vuoto( cognome_field, "WARNING! Insert Surname."))
				    return false;
				  else
				  if (! cf( cf_field, "ATTENZIONE! The tax code must be of 16 characters."))
				    return false;
				  else
				  if (! mail( mail_field, "WARNING! Check the e-mail."))
				   return false;
				  else
			       if (! telefono( telefono_field, "WARNING! The phone number must be of 10 digits."))
				  return false;
				  else
				  ...
				  if (! eta( date_chooser, "WARNING! Employee must be 16 or older."))
				  return false;
				  else
				    return true;
	...
	public boolean cf(JTextField f, String errore ) {
		...
		if(s.length()!=16) {
			...
			return fallito( f, "WARNING! The tax code must only contains letters and numbers." );
	...
	String EMAIL_PATTERN = 
		...
		if(!vuoto(f, "WARNING! Insert the e-mail."))
		return false;
