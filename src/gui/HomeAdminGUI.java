...
public class HomeAdminGUI extends JFrame {
	private String[] nomiColonne = {"Id", "City", "Address", "State"};
	...
	public HomeAdminGUI(controller.Controller controller, ArrayList<Cantiere> listaCantieri) {
		...
		JLabel lista_label = new JLabel("Building Sites List");
		...
		JButton info_button = new JButton("Building Site Infos");
		...
		JButton cantiere_button = new JButton("Add Building Site");
		...
		JButton admin_button = new JButton("Create Admin");
		...
		JButton aperti_button = new JButton("Opened Building Sites");
		...
		JButton chiusi_button = new JButton("Closed Building Sites");
