...
public class AggiungiDatoGasGUI extends JFrame {
	private JTextField valore_field;

	public AggiungiDatoGasGUI(controller.Controller controller, int id) {
			//Grandezza finestra
			setSize(412,247);
			setResizable(false);
			...
			JLabel sensore = new JLabel("Sensor:");
			...
			submit_button.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					dato(controller,id);
					controller.chiudiAggiungiDatoGasGUI();
