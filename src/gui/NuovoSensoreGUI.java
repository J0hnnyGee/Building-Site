...
public class NuovoSensoreGUI extends JFrame {
	...
	public NuovoSensoreGUI(controller.Controller controller, String id) {
				...
				JLabel heading = new JLabel("New Sensor");
				...
				JLabel posizione_label = new JLabel("Position:");
				...
				JLabel tipo_label = new JLabel("Type:");
				...
				JLabel inserito_label = new JLabel("Insert by:");
				...
				JLabel id_label = new JLabel("Zone Id:");
	...
	//METODI
		...
		public boolean check() {
	 		if (! vuoto( posizione_field, "WARNING! Insert Position."))
			    return false;
	 		else return true;
		}
